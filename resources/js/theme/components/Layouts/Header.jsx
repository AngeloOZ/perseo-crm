            ...
            <div className="shadow-sm">
                ...
                <ul className="horizontal-menu hidden py-1.5 font-semibold px-6 lg:space-x-1.5 xl:space-x-8 rtl:space-x-reverse bg-white border-t border-[#ebedf2] dark:border-[#191e3a] dark:bg-black text-black dark:text-white-dark">
                    {menuDashboard.map((item) => (
                        <RenderMenuHeader key={item.id} menuItem={item} />
                    ))}
                    ...
                    {/* <li className="menu nav-item relative">
                        ...
                        <ul className="sub-menu">
                            ...
                            <li>
                                <Link to="/components/countdown">
                                    {t("countdown")}
                                </Link>
                            </li>
                            <li>
                                <Link to="/components/counter">
                                    {t("counter")}
                                </Link>
                            </li>
                            <li>
                                <Link to="/components/sweetalert">
                                    {t("sweet_alerts")}
                                </Link>
                            </li>
                            <li>
                    ...
                    <li className="menu nav-item relative">
                        ...
                        <ul className="sub-menu">
                            ...
                            <li>
                                <Link to="/elements/breadcrumbs">
                                    {t("breadcrumbs")}
                                </Link>
                            </li>
                            <li>
                                <Link to="/elements/buttons">
                                    {t("buttons")}
                                </Link>
                            </li>
                            <li>
                                <Link to="/elements/buttons-group">
                                    {t("button_groups")}
                                </Link>
                            </li>
                            <li>
                                <Link to="/elements/color-library">
                                    {t("color_library")}
                                </Link>
                            </li>
                            <li>
                                <Link to="/elements/dropdown">
                                    {t("dropdown")}
                                </Link>
                            </li>
                            <li>
                                <Link to="/elements/infobox">
                                    {t("infobox")}
                                </Link>
                            </li>
                            <li>
                                <Link to="/elements/jumbotron">
                                    {t("jumbotron")}
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link to="/elements/pagination">
                                    {t("pagination")}
                                </Link>
                            </li>
                            <li>
                                <Link to="/elements/popovers">
                                    {t("popovers")}
                                </Link>
                            </li>
                            <li>
                                <Link to="/elements/progress-bar">
                                    {t("progress_bar")}
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link to="/elements/tooltips">
                                    {t("tooltips")}
                                </Link>
                            </li>
                            <li>
                                <Link to="/elements/treeview">
                                    {t("treeview")}
                                </Link>
                            </li>
                            <li>
                                <Link to="/elements/typography">
                                    {t("typography")}
                                </Link>
                            </li>
                        </ul>
                        ...
                        <ul className="sub-menu">
                            ...
                            <li className="relative">
                                ...
                                <ul className="rounded absolute top-0 ltr:left-[95%] rtl:right-[95%] min-w-[180px] bg-white z-[10] text-dark dark:text-white-dark dark:bg-[#1b2e4b] shadow p-0 py-2 hidden">
                                    <li>
                                        <Link to="/datatables/basic">
                                            {t("basic")}
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/datatables/advanced">
                                            {t("advanced")}
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/datatables/skin">
                                            {t("skin")}
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/datatables/order-sorting">
                                            {t("order_sorting")}
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/datatables/multi-column">
                                            {t("multi_column")}
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/datatables/multiple-tables">
                                            {t("multiple_tables")}
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/datatables/alt-pagination">
                                            {t("alt_pagination")}
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/datatables/checkbox">
                                            {t("checkbox")}
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/datatables/range-search">
                                            {t("range_search")}
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/datatables/export">
                                            {t("export")}
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/datatables/column-chooser">
                                            {t("column_chooser")}
                                        </Link>
                                    </li>
                                </ul>
                    ...
                    <li className="menu nav-item relative">
                        ...
                        <ul className="sub-menu">
                            ...
                            <li>
                                <Link to="/forms/touchspin">
                                    {t("touchspin")}
                                </Link>
                            </li>
                            <li>
                                <Link to="/forms/checkbox-radio">
                                    {t("checkbox_and_radio")}
                                </Link>
                            </li>
                            <li>
                                <Link to="/forms/switches">
                                    {t("switches")}
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link to="/forms/quill-editor">
                                    {t("quill_editor")}
                                </Link>
                            </li>
                            <li>
                                <Link to="/forms/markdown-editor">
                                    {t("markdown_editor")}
                                </Link>
                            </li>
                            <li>
                                <Link to="/forms/date-picker">
                                    {t("date_and_range_picker")}
                                </Link>
                            </li>
                            <li>
                                <Link to="/forms/clipboard">
                                    {t("clipboard")}
                                </Link>
                            </li>
                        </ul>
...
function RenderMenuHeader({ menuItem }) {
    return (
        <li className="menu nav-item relative">
            <button type="button" className="nav-link">
                <div className="flex items-center">
                    {menuItem.icon}
                    <span className="px-1">{menuItem.title}</span>
                </div>
                {menuItem.chevron && (
                    <div className="right_arrow">
                        <IconCaretDown />
            ...
            <ul className="sub-menu">
                {menuItem.children.map((item) => (
                    <RenderItemMenu key={item.id} item={item} />
                ))}
            </ul>
        </li>
    );
